...
/*
  ES2 - Modificare il programma 2021-10-15-codice.c (gestione di un percorso) visto 
  in aula aggiungendovi le seguenti due nuove funzionalità: 
  7 - Ricerca di una località dato il nome. La funzionalità chiede all'utente il 
      nome di una località (una stringa di al massimo 30 caratteri) e stampa a video 
      i dati di tutte le località con quel dato nome. Si ricordi che per confrontare 
      le stringhe si può usare la funzione strcmp() contenuta in string.h che riceve 
      come parametri due stringhe e restituisce 0 se sono uguali.
  8 - Calcola cornice del percorso. La funzionalità calcola la cornice rettangolare 
      sulla cartina che racchiude tutto il percorso e ne visualizza le coordinate dei 
      due vertici in basso a sinistra ed in alto a destra. Visualizzare un apposito 
      messaggio di errore nel caso il percorso sia vuoto.
