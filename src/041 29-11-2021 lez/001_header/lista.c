...
/* Questo file non ha bisogno di un main, perché non va eseguito da solo. */
...
/*
  Inserisce un numero nella lista rispettando un ordine crescente (affinchè
  l'ordine crescente sia preservato durante l'inserimenti, si assume che la
  lista di partenza sia ordinata in tale ordine)
*/
...
/*
  Rimuove dalla lista la prima occorrenza di un numero specificato come
...
/*
  Rimuove dalla lista tutte le occorrenze di un numero specificato come
  parametro, se presente
*/
